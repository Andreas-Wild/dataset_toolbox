...
from toolbox.utilities import pixel_colour, remove_pixel, merge_mask, grow_mask, shrink_mask, split_connected, overlay, array_to_base64
...
class DatasetEditor:
    ...
    def refresh_display(self):
        ...
        overlay_img = overlay(img, mask)
        
        # Update the interactive image source
        b64 = array_to_base64(overlay_img)
