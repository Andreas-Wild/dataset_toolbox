...
class OMEConverter:
    ...
    def __init__(self, input_path: str | Path, output_path: str | Path):
        ...
        # Parse output path to be a path
    ...
    def convert(self):
        ...
        try:
            ...
            print(e)
        # Get one representative file per image (using the first known channel),
        # then _read_channel will swap in the correct channel suffix.
        filenames: list[Path] = sorted(
